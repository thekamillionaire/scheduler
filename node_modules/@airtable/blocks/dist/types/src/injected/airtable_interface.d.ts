...
/** @hidden */
declare type FieldConfigValidationResult = {
    isValid: true;
} | {
    isValid: false;
    reason: string;
...
interface FieldTypeProvider {
    ...
    validateConfigForUpdate(appInterface: AppInterface, newConfig: FieldTypeConfig, currentConfig: FieldTypeConfig | null, fieldData: FieldData | null, billingPlanGrouping: string): FieldConfigValidationResult;
    canBePrimary(appInterface: AppInterface, config: FieldTypeConfig, billingPlanGrouping: string): boolean;
