...
/** @hidden */
export declare type ResponsiveKey = keyof ResponsivePropObject<unknown>;
/**
 ...
 */
export declare type ResponsiveProp<T> = T | ResponsivePropObject<T>;
/**
 * An optional {@link ResponsiveProp} that can be null or undefined.
 */
export declare type OptionalResponsiveProp<T> = ResponsiveProp<T> | undefined | null;
/** @hidden */
