...
import { AppearanceSetProps, DimensionsSetProps, FlexContainerSetProps, FlexItemSetProps, PositionSetProps, SpacingSetProps, TypographySetProps, DisplayProps, OverflowProps } from './index';
/**
 ...
 */
export interface AllStylesProps extends AppearanceSetProps, DimensionsSetProps, FlexContainerSetProps, FlexItemSetProps, PositionSetProps, SpacingSetProps, TypographySetProps, DisplayProps, OverflowProps {
}
export declare const allStylesParser: import("@styled-system/core").styleFn;
export declare const allStylesPropTypes: {
    [x: string]: import("prop-types").Validator<any>;
};
//# sourceMappingURL=all_styles_set.d.ts.map