...
declare class Table extends AbstractModel<TableData, WatchableTableKey> {
     ...
     * ```
     */
    unstable_checkPermissionsForCreateField(name?: string, type?: FieldType, options?: FieldOptions | null): PermissionCheckResult;
    /**
     * _Beta feature with unstable API. May have breaking changes before release._
     *
     ...
     * ```
     */
    unstable_hasPermissionToCreateField(name?: string, type?: FieldType, options?: FieldOptions | null): boolean;
    /**
     * _Beta feature with unstable API. May have breaking changes before release._
     *
     * Creates a new field.
     ...
     * ```
     */
    unstable_createFieldAsync(name: string, type: FieldType, options?: FieldOptions | null): Promise<Field>;
}
