      ...
      onCodePathEnd: function (codePath, codePathNode) {
        ...
        function countPathsFromStart(segment, pathHistory) {
          ...
          if (pathList.has(segment.id)) {
            ...
            try {
              for (var _iterator = cyclicSegments[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        function countPathsToEnd(segment, pathHistory) {
          ...
          if (pathList.has(segment.id)) {
            ...
            try {
              for (var _iterator3 = cyclicSegments[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
var ExhaustiveDeps = {
  ...
  create: function (context) {
    ...
    function visitFunctionExpression(node) {
      ...
      var isEffect = /Effect($|[^a-z])/g.test(reactiveHookName); // Get the declared dependencies for this reactive hook. If there is no
      ...
      if (problemCount === 0) {
        ...
        bareFunctions.forEach(function (_ref4) {
          ...
          var suggest; // Only handle the simple case: arrow functions.
